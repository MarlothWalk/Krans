...
function toggleLanguage(elem)
{
	...
	langelems = document.getElementsByClassName('langoption')
	for (let i =0;i<langelems.length;i++)
	{
		langelems[i].className = 'langoption'
	}
	elem.className = 'langoption chosen'
...
function setLanguage(name)
{
	...
	var titles = {
		'english':'Marlothii Conservancy Self-Guided Tree Walk',
		'afrikaans':'Marlothii Bewarea Self-Begeleide Boomwandeling Roete',
		'french':"Marlothii Conservancy ' Guide pour la promenade découverte des arbres de Marloth Park",
		'german':"Marlothii Conservancy Baum Lehrpfad zum selbst-erkunden.",
		'siswati':"Marlothii Conservancy imayelana nekuticodzisa kwemuntfu nangabe kuhanjwa kubukwa tihlahla"}
